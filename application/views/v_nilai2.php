...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      ...
      <h1 style="font-family: 'Lobster Two', cursive !important; color:white">Penilaian Kostum <br> Favorit Perpang</h1>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form role="form" method="post" action="<?= base_url() ?>admin/editNilai2">
                    ...
                    <div class="form-group ml-auto">
                      <label for="kostum">Kostum</label>
                      <input type="number" class="boks form-control" id="kostum" name="kostum" value="<?= $p->kostum ?>">
                    </div>
                    <div class="form-group ml-auto">
                      <label for="favorit">Favorit</label>
                      <input type="number" class="boks form-control" id="favorit" name="favorit" value="<?= $p->favorit ?>">
                    </div>
                    <div class="form-group ml-auto">
                      <label for="ujianperpang">Ujian Perpang</label>
                      <input type="number" class="boks form-control" id="ujianperpang" name="ujianperpang" value="<?= $p->ujianperpang ?>">
                    </div>
